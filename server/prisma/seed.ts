...
async function main() {
  ...
  await prisma.orden.create({
    data: {
      fechaOrden: new Date('2023-05-27'),
      usuarioId: 4,
      videojuegos: {
        createMany: {
          data: [
  ...
  await prisma.orden.create({
    data: {
      fechaOrden: new Date('2023-05-30'),
      usuarioId: 3,
      videojuegos: {
        createMany: {
  ...
  await prisma.orden.create({
    data: {
      fechaOrden: new Date('2023-06-20'),
      usuarioId: 2,
      videojuegos: {
        createMany: {
          data: [
  ...
  await prisma.orden.create({
    data: {
      fechaOrden: new Date('2023-06-27'),
      usuarioId: 2,
      videojuegos: {
        createMany: {
          data: [
  ...
  await prisma.orden.create({
    data: {
      fechaOrden: new Date('2023-07-02'),
      usuarioId: 1,
      videojuegos: {
        createMany: {
  ...
  await prisma.orden.create({
    data: {
      fechaOrden: new Date('2023-07-05'),
      usuarioId: 4,
      videojuegos: {
        createMany: {
  ...
  await prisma.orden.create({
    data: {
      fechaOrden: new Date('2023-07-15'),
      usuarioId: 3,
      videojuegos: {
        createMany: {
          data: [
